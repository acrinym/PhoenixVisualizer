# Remove-LanguagePacks.ps1
# Script to remove non-English language packs from Windows Apps and Metro apps
...
Write-Host "=== Language Pack Cleanup Script ===" -ForegroundColor Cyan
...
# Additional Windows language resources
Write-Host "`n=== Scanning Additional Language Resources ===" -ForegroundColor Cyan

# Windows language resources
$additionalPaths = @(
...
Write-Host "`nLanguage pack cleanup completed!" -ForegroundColor Green
if (-not $WhatIf) {
    Write-Host "You may need to restart some applications for changes to take effect." -ForegroundColor Yellow
}
