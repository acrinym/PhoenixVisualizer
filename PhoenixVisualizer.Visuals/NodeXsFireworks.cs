...
{
    public sealed class NodeXsFireworks : IVisualizerPlugin
    {
        private IEffectNode _node = new XsFireworksNode();
        public string Id => "node_xs_fireworks";
        public string DisplayName => "XS Fireworks (Node)";
        private int _w,_h;
