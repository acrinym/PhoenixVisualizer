...
{
    public sealed class NodeXsVortex : IVisualizerPlugin
    {
        private IEffectNode _node = new XsVortexNode();
        public string Id => "node_xs_vortex";
        public string DisplayName => "XS Vortex (Node)";
        private int _w,_h;
