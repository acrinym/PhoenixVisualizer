...
{
    public sealed class NodeXsPlasma : IVisualizerPlugin
    {
        private IEffectNode _node = new XsPlasmaNode();
        public string Id => "node_xs_plasma";
        public string DisplayName => "XS Plasma (Node)";
        private int _w,_h;
