    ...
    public class TexturedParticleSystemEffectsNode : BaseEffectNode
    {
        ...
        public override Dictionary<string, object> GetConfiguration()
        {
            return new Dictionary<string, object>
            {
                ...
                { "VelocityAngleSpread", VelocityAngleSpread },
        ...
        public override void ApplyConfiguration(Dictionary<string, object> config)
        {
            ...
            if (config.TryGetValue("MaxParticles", out var maxParticles))
            {
                MaxParticles = Convert.ToInt32(maxParticles);
                InitializeParticleSystem();
            }
            
            // Apply all other configuration values...
            // (Implementation truncated for brevity, but would include all properties)
        }
