    ...
    public class VectorFieldEffectsNode : BaseEffectNode
    {
        ...
        public override Dictionary<string, object> GetConfiguration()
        {
            return new Dictionary<string, object>
            {
                ...
                { "BeatStrengthMultiplier", BeatStrengthMultiplier },
                { "AudioReactiveField", AudioReactiveField },
                { "AudioSensitivity", AudioSensitivity },
                { "StreamlineCount", StreamlineCount },
                { "StreamlineLength", StreamlineLength },
                { "ParticleCount", ParticleCount },
                { "ParticleLifetime", ParticleLifetime },
                { "FieldScale", FieldScale },
                { "NoiseScale", NoiseScale },
                { "EnablePersistence", EnablePersistence },
                { "PersistenceDecay", PersistenceDecay }
            };
        }

        public override void ApplyConfiguration(Dictionary<string, object> config)
        {
            // Implementation of configuration application
            // (Full implementation would include all properties)
        }
